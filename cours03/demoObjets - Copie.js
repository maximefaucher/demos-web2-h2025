...
let sommeAgesTableau = personnes.reduce((somme, element) => somme + element.age, 0);
console.log("L'âge moyen des éléments du tableau est", sommeAgesTableau/personnes.length, "ans.");
